...
(task-options!
  pom {:project     'quamolit/quamolit-workflow
       :version     +version+
       :description "Quamolit is declarative animation library for Canvas"
       :url         "https://github.com/Quamolit/quamolit-workflow"
       :scm         {:url "https://github.com/Quamolit/quamolit-workflow"}
...
(deftask rsync []
  (with-pre-wrap fileset
    (sh "rsync" "-r" "target/" "repo.tiye.me:repo/Quamolit/workflow" "--exclude" "main.out" "--delete")
    fileset))
